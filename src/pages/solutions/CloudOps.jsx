  ...
  return (
    <main className="flex-1">
      <section className="min-h-[60vh] flex items-center justify-center text-center pt-[80px] relative overflow-hidden">
        <div className="absolute top-1/2 left-1/2 w-[600px] h-[600px] bg-[radial-gradient(circle,rgba(249,115,22,0.15)_0%,transparent_70%)] -translate-x-1/2 -translate-y-1/2 blur-[60px] -z-10 animate-[drift_10s_infinite_alternate_ease-in-out]"></div>
        ...
        <div className="container mx-auto px-[5%] fade-up">
          <h1 className="text-[clamp(3.5rem,6vw,5rem)] font-extrabold tracking-tight leading-[1.1] mb-6 text-white">
            Cloud <span className="text-tech-indigo">Ops</span>
          </h1>
          <p className="text-lg text-muted max-w-2xl mx-auto">
            Advanced DevOps and reliable cloud infrastructure management engineered for speed and uptime.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-[5%]">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="glass-panel p-8 rounded-2xl hover:border-tech-indigo/30 hover:shadow-[0_10px_30px_-10px_rgba(249,115,22,0.15)] hover:bg-tech-gray/65 hover:-translate-y-1 transition-all duration-300 fade-up">
              <i className="fa-solid fa-server text-4xl text-tech-indigo mb-6 block"></i>
              <h3 className="text-2xl font-extrabold mb-4 text-white">Managed Hosting</h3>
              <p className="text-lg text-muted">
                Enterprise-grade infrastructure management across AWS, GCP, and Azure with guaranteed 99.9% uptime SLA.
              </p>
            </div>
            <div className="glass-panel p-8 rounded-2xl hover:border-tech-sky/30 hover:shadow-[0_10px_30px_-10px_rgba(34,211,238,0.15)] hover:bg-tech-gray/65 hover:-translate-y-1 transition-all duration-300 fade-up">
              <i className="fa-solid fa-[#2496ED] fa-docker text-4xl text-tech-sky mb-6 block"></i>
              <h3 className="text-2xl font-extrabold mb-4 text-white">Containerization</h3>
              <p className="text-lg text-muted">
                Docker and Kubernetes orchestration for zero-downtime deployments and effortless auto-scaling.
              </p>
            </div>
            <div className="glass-panel p-8 rounded-2xl hover:border-tech-blue/30 hover:shadow-[0_10px_30px_-10px_rgba(6,182,212,0.15)] hover:bg-tech-gray/65 hover:-translate-y-1 transition-all duration-300 fade-up">
              <i className="fa-solid fa-diagram-project text-4xl text-tech-blue mb-6 block"></i>
              <h3 className="text-2xl font-extrabold mb-4 text-white">CI/CD Automation</h3>
              <p className="text-lg text-muted">
                Automated continuous integration and deployment pipelines to accelerate release cycles safely.
              </p>
            </div>
          </div>
