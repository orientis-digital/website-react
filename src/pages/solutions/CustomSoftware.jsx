      ...
      <section className="min-h-[60vh] flex items-center justify-center text-center pt-[80px] relative overflow-hidden">
        ...
        <div className="container mx-auto px-[5%] fade-up">
          <h1 className="text-[clamp(3.5rem,6vw,5rem)] font-extrabold tracking-tight leading-[1.1] mb-6 text-white">
            Custom <span className="text-tech-sky">Software</span>
          </h1>
          <p className="text-lg text-muted max-w-2xl mx-auto">
            Developing unique, mobile-responsive applications with a focus on performance and scalability.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-[5%]">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="glass-panel p-8 rounded-2xl hover:border-tech-sky/30 hover:shadow-[0_10px_30px_-10px_rgba(34,211,238,0.15)] hover:bg-tech-gray/65 hover:-translate-y-1 transition-all duration-300 fade-up">
              <i className="fa-solid fa-code text-4xl text-tech-sky mb-6 block"></i>
              <h3 className="text-2xl font-extrabold mb-4 text-white">Modern Tech Stack</h3>
              <p className="text-lg text-muted">
                We build applications using the latest frameworks and technologies. Efficient, maintainable, and robust code by default.
              </p>
            </div>
            <div className="glass-panel p-8 rounded-2xl hover:border-tech-blue/30 hover:shadow-[0_10px_30px_-10px_rgba(6,182,212,0.15)] hover:bg-tech-gray/65 hover:-translate-y-1 transition-all duration-300 fade-up">
              <i className="fa-solid fa-gauge-high text-4xl text-tech-blue mb-6 block"></i>
              <h3 className="text-2xl font-extrabold mb-4 text-white">Performance First</h3>
              <p className="text-lg text-muted">
                Fine-tuning site speed and reliability using advanced caching, global CDNs, and optimized delivery pipelines.
              </p>
            </div>
            <div className="glass-panel p-8 rounded-2xl hover:border-tech-indigo/30 hover:shadow-[0_10px_30px_-10px_rgba(249,115,22,0.15)] hover:bg-tech-gray/65 hover:-translate-y-1 transition-all duration-300 fade-up">
              <i className="fa-solid fa-cart-shopping text-4xl text-tech-indigo mb-6 block"></i>
              <h3 className="text-2xl font-extrabold mb-4 text-white">E-commerce & Apps</h3>
              <p className="text-lg text-muted">
                Building scalable online stores and custom business applications tailored to your unique requirements.
              </p>
            </div>
          </div>
