  ...
  return (
    <main className="flex-1 pt-28 pb-24 min-h-[85vh]">
      ...
      <section className="relative overflow-hidden pt-12 pb-16">
        <div className="absolute top-1/2 left-1/2 w-[600px] h-[400px] bg-impeccable-amber/15 -translate-x-1/2 -translate-y-1/2 blur-[90px] pointer-events-none -z-10 transform-gpu"></div>
      ...
      <section className="py-8 relative z-10">
        <div className="container mx-auto px-[5%] max-w-[1150px]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch mb-8">
            ...
            <div className="glass-panel p-8 md:p-10 rounded-3xl border border-impeccable-amber/40 relative overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.5)] flex flex-col justify-between hover:border-impeccable-amber/70 transition-all duration-300">
              <div className="absolute top-0 right-0 w-[300px] h-[300px] bg-impeccable-orange/15 rounded-full blur-[80px] pointer-events-none transform-gpu"></div>
            ...
            {/* Card 2: Cipherly */}
            <div className="glass-panel p-8 md:p-10 rounded-3xl border border-impeccable-orange/40 relative overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.5)] flex flex-col justify-between hover:border-impeccable-orange/70 transition-all duration-300">
              <div className="absolute top-0 right-0 w-[300px] h-[300px] bg-impeccable-amber/15 rounded-full blur-[80px] pointer-events-none transform-gpu"></div>

              <div>
                <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
                  <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full border border-impeccable-orange/40 bg-impeccable-orange/10 text-impeccable-orange text-xs font-mono uppercase tracking-widest">
                    <i className="fa-solid fa-lock"></i> Desktop Encryption Utility
                  </div>
                  <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-emerald-500/30 bg-emerald-500/10 text-emerald-400 text-[11px] font-mono uppercase tracking-wider">
                    <i className="fa-solid fa-circle-check"></i> Cross-Platform App
                  </div>
                </div>

                <div className="flex items-center gap-5 mb-5">
                  <div className="w-16 h-16 rounded-2xl bg-impeccable-orange/10 border border-impeccable-orange/30 p-2 shadow-impeccable flex items-center justify-center shrink-0">
                    <img
                      src="/static/img/cipherly-icon.png"
                      alt="Cipherly Encryption Suite Logo"
                      className="w-full h-full object-contain drop-shadow-md"
                    />
                  </div>
                  <div>
                    ...
                    <p className="text-impeccable-orange font-mono text-xs uppercase tracking-wider mt-1">
                      Offline Encryption &amp; Steganography Tool
                    </p>
                  </div>
                </div>

                <p className="text-gray-300 text-sm leading-relaxed font-sans mb-6">
                  Cipherly is a powerful desktop encryption suite built for offline file protection, secure text vaulting, and advanced image steganography to conceal confidential data within media.
                </p>

                {/* Feature Highlights */}
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6">
                  <div className="flex items-start gap-2.5 p-3 rounded-xl bg-white/5 border border-white/10">
                    <i className="fa-solid fa-file-lock text-impeccable-amber text-sm mt-0.5"></i>
                    <div>
                      <h4 className="text-[11px] font-bold text-white uppercase font-display">AES-256 File &amp; Text Vault</h4>
                      <p className="text-[10px] text-gray-400 font-sans">Zero cloud dependency</p>
                    </div>
                  </div>

                  <div className="flex items-start gap-2.5 p-3 rounded-xl bg-white/5 border border-white/10">
                    <i className="fa-solid fa-image text-impeccable-orange text-sm mt-0.5"></i>
                    <div>
                      <h4 className="text-[11px] font-bold text-white uppercase font-display">Image Steganography</h4>
                      <p className="text-[10px] text-gray-400 font-sans">Hide text &amp; files in images</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          {/* Full-width Horizontal R&D Banner */}
          <div className="glass-panel p-8 md:p-10 rounded-3xl border border-white/15 relative overflow-hidden shadow-2xl bg-gradient-to-r from-tech-gray/80 via-tech-black/90 to-tech-gray/80">
            <div className="absolute top-0 right-0 w-[350px] h-[350px] bg-impeccable-amber/10 rounded-full blur-[80px] pointer-events-none transform-gpu"></div>

            <div className="flex flex-col md:flex-row items-center justify-between gap-8">
              <div className="flex-1">
                <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full border border-impeccable-orange/40 bg-impeccable-orange/10 text-impeccable-orange text-xs font-mono uppercase tracking-widest mb-4">
                ...
                <p className="text-gray-300 text-sm leading-relaxed font-sans max-w-[700px]">
                  Our engineering team is actively developing next-generation encrypted communication relays, secure hardware vaults, and modular enterprise platforms.
                </p>
              </div>
              ...
              <div className="shrink-0 w-full md:w-auto">
                <Link
                  to="/contact"
                  className="inline-flex items-center justify-center gap-2 px-6 py-3.5 text-xs font-bold font-display uppercase tracking-wider text-white border border-impeccable-amber/40 bg-impeccable-amber/10 rounded-xl hover:bg-impeccable-amber hover:text-white transition-all w-full md:w-auto"
                >
